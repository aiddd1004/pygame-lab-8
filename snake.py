...
# fruit class -> food for the snake
class Fruit:
    def __init__(self):
    ...
    def randomize(self, snake_body):
         # generating random position for the fruit so it won't appear on the body of the snake
        while True:
...
class Snake:
    ...
    def move(self):
        if self.new_block: # new block if the snake has eaten a fruit
            body_copy = self.body[:]
